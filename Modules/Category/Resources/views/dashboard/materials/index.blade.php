...
@section('title', __('category::dashboard.materials.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('category::dashboard.materials.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        @can('add_materials')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.materials.create')) }}"
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                {{__('category::dashboard.materials.routes.index')}}
                            </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.materials.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.materials.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('category::dashboard.materials.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.materials.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.materials.destroy", ":id") }}';
